...
## For Linux or MacOS
  ...
  * Export Environment variables
    ...
    | ------------- | ----- |
    | QT_API        | The version of the Qt API to generate. This is `5.12.0` for 5.12.X or `5.13.0` for 5.13.X. |
  ...
  * Build
    ...
    ```
    $(go env GOPATH)/bin/qtdeploy -qt_api 5.12.0 build desktop
    ```
...
## For Windows
  ...
  * Build
    ...
    ```
    %GOPATH%/bin/qtdeploy -qt_api 5.12.0 build desktop
    ```


For more information, please see the following:
[https://github.com/therecipe/qt/wiki/Installation](https://github.com/therecipe/qt/wiki/Installation)
