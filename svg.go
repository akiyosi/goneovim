...
func initSVGS() {
	...
	svgs["cross"] = &SvgXML{
		...
		height:    100,
		thickness: 2,
		xml:       `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"><g><path d="M25 25L75 75zM75 25 L25 75"/></g></svg>`,
	}
	svgs["default"] = &SvgXML{
		width:     200,
		height:    200,
		...
		xml:       `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><g><path d="M22.34999879828441,17.7129974066314 h147.91225647948028 v20.748584330809138 H22.34999879828441 V17.7129974066314 zM22.34999879828441,65.18324337560382 h126.22055467908892 v20.748584330809138 H22.34999879828441 V65.18324337560382 zM22.34999879828441,113.91097930401922 h155.3000099912078 v20.748584330809138 H22.34999879828441 V113.91097930401922 zM22.34999879828441,161.538411517922 h91.01083581468554 v20.748584330809138 H22.34999879828441 V161.538411517922 z"/></g></svg>`,
	}
	svgs["folder"] = &SvgXML{
		width:     32,
		height:    32,
		thickness: 0,
		color:     &editor.Foreground,
		xml:       `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><g><path d="M28.8 6.9H16.1V5.7c0-1.4-1.1-2.5-2.5-2.5H.6v25.6h30.6V9.4c.1-1.4-1-2.5-2.4-2.5z"/></g></svg>`,
	}
	svgs["git"] = &SvgXML{
		width:     128,
		height:    128,
	...
	svgs["check"] = &SvgXML{
		...
		xml:       `<svg width="1792" height="1792" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><g><path d="M1671 566l-724 724-136 136l-136-136-362-362l136-136l294 295 656-657l136 136z"/></g></svg>`,
	}
	svgs["exclamation"] = &SvgXML{
		...
		xml:       `<svg width="1792" height="1792" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><g><path d="M1088 1248v224h-256v-224h256zm30-1056l-28 768h-256l-28-768h320z"/></g></svg>`,
	}
	svgs["sh"] = &SvgXML{
		width:     18,
		height:    18,
