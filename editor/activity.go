...
func newActivity() *Activity {
	...
	editIcon.SetFixedWidth((editor.config.Editor.FontSize - 2) * 2)
	editIcon.SetFixedHeight((editor.config.Editor.FontSize - 2) * 2)
	...
	deinIcon.SetFixedWidth((editor.config.Editor.FontSize - 2) * 2)
	deinIcon.SetFixedHeight((editor.config.Editor.FontSize - 2) * 2)
